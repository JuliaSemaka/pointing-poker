        ...
        <div className="footer-github">
          <ul className="footer-github-list">
            <li className="footer-github-item">
              ...
              <a href="https://github.com/YekaterinaKarakulina" className="footer-github-text text">Yekaterina</a>
            </li>
            <li className="footer-github-item">
              <span className="text text-ruda footer-github-text">Teamlead: </span>
              <a href="https://github.com/JuliaSemaka" className="footer-github-text text">Julia</a>
            </li>
            <li className="footer-github-item">
              <span className="text text-ruda footer-github-text">Developer: </span>
              <a href="https://github.com/IvanYatsko" className="footer-github-text text">Ivan</a>
            </li>
            <li className="footer-github-item">
              <span className="text text-ruda footer-github-text">Developer: </span>
              <a href="https://github.com/Maxfri" className="footer-github-text text">Iaroslav</a>
            </li>
          </ul>
        </div>
      </div>
